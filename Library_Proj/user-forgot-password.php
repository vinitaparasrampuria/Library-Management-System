...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EMAIL FROM VKM_CUSTOMER WHERE EMAIL=:email and PHN_NO=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update VKM_CUSTOMER set Password1=:newpassword where EMAIL=:email and PHN_NO=:mobile";
