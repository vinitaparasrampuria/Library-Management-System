...
$sql1 = "delete from VKM_SEM_SPNSR WHERE EVENT_ID=:EVENT_ID";
$sql2 = "delete from VKM_SEMINAR WHERE EVENT_ID=:EVENT_ID";
$sql3 = "delete from VKM_EVENT WHERE EVENT_ID=:EVENT_ID";
...
$query2 -> bindParam(':EVENT_ID',$EVENT_ID, PDO::PARAM_STR);
$query3 -> bindParam(':EVENT_ID',$EVENT_ID, PDO::PARAM_STR);
$query0 -> execute();
$query00 -> execute();
$query -> execute();
$query1 -> execute();
...
<head>
    ...
    <title>Online Library Management System | Manage Events</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php 
$sql = "SELECT EVENT_ID, ENAME, ETYPE, START_DATE1, STOP_DATE, VKM_TOPIC.TOPIC_DESC as TOPIC_DESC FROM VKM_EVENT JOIN VKM_TOPIC ON VKM_EVENT.TOPIC_ID=VKM_TOPIC.TOPIC_ID";
$query = $dbh -> prepare($sql);
$query->execute();
...
{             
     ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="edit-event.php?EVENT_ID=<?php echo htmlentities($result->EVENT_ID);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                                          <a href="view-events.php?del=<?php echo htmlentities($result->EVENT_ID);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
